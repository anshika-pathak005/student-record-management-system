...
class StudentManagement:
    def __init__(self,root):
        ...
        # mainframe for all the widgets and text boxes
        self.main_frame = Frame(root, width=1200, height=545, bg="white", bd=0, highlightthickness=0)
        self.main_frame.place(x=80, y=140)

        self.title = ctk.CTkLabel(self.main_frame,
                                text="Student Management Pannel",
        ...
        # widgets and the button all the in the frame will come her
...
# =======================COLUMN-1==========================================================
        ...
        # input fields
        roll_num = Label(self.main_frame,text="Roll No. *",font=("Segoe UI", 13),bg="white").place(x=40,y=110)
        name_lbl = Label(self.main_frame,text="Name *",font=("Segoe UI", 13),bg="white").place(x=40,y=150)
        email_lbl = Label(self.main_frame,text="Email *",font=("Segoe UI", 13),bg="white").place(x=40,y=190)
        gender_lbl = Label(self.main_frame,text="Gender",font=("Segoe UI", 13),bg="white").place(x=40,y=230)

        state_lbl = Label(self.main_frame,text="State",font=("Segoe UI", 13),bg="white").place(x=40,y=270)
        state_text = ctk.CTkEntry(self.main_frame, textvariable=self.state_var, font=("Helvetica", 15), corner_radius=5, fg_color="white", border_color="grey", border_width=1, text_color="black", width=150, height=35).place(x=140, y=270)

        city_lbl = Label(self.main_frame,text="City",font=("Segoe UI", 13),bg="white").place(x=300,y=270)
        city_text = ctk.CTkEntry(self.main_frame, textvariable=self.city_var, font=("Helvetica", 15), corner_radius=5, fg_color="white", border_color="grey", border_width=1, text_color="black", width=130, height=35).place(x=350, y=270)

        pin_lbl = Label(self.main_frame,text="Pin *",font=("Segoe UI", 13),bg="white").place(x=495,y=270)
        pin_text = ctk.CTkEntry(self.main_frame, textvariable=self.pin_var, font=("Helvetica", 15), corner_radius=5, fg_color="white", border_color="grey", border_width=1, text_color="black", width=130, height=35,validate="key",validatecommand=vcmd).place(x=540, y=270)


        address_lbl = Label(self.main_frame,text="Address",font=("Segoe UI", 13),bg="white").place(x=40,y=310)
        

        # user input here--------------------------------------------------------

        self.roll_no_text = ctk.CTkEntry(self.main_frame, textvariable=self.roll_var, font=("Helvetica", 15), corner_radius=5, fg_color="white", border_color="gray", border_width=1, text_color="black", width=200, height=35,validate="key",validatecommand=vcmd)
        ...
        name_txt = ctk.CTkEntry(self.main_frame,textvariable=self.name_var,font=("Helvetica", 15),corner_radius=5, fg_color="white", border_color="gray", border_width=1,text_color="black", width=200, height=35).place(x=140,y=150)


        email_txt = ctk.CTkEntry(self.main_frame, textvariable=self.email_var, font=("Helvetica", 15), corner_radius=5, fg_color="white", border_color="grey", border_width=1, text_color="black", width=200, height=35).place(x=140, y=190)


        self.gender_txt = ctk.CTkComboBox(self.main_frame, values=["Male", "Female", "Other"], variable=self.gender_var, font=("Helvetica", 15),state='readonly', corner_radius=5, fg_color="white", border_color="grey", border_width=1, text_color="black", width=200, height=35, dropdown_font=("Helvetica", 15), dropdown_fg_color="white", dropdown_text_color="black", button_color="#a6a5a5", button_hover_color="#e0e0e0")
        self.gender_txt.place(x=140, y=230)


        self.address_txt = ctk.CTkTextbox(self.main_frame, font=("Helvetica", 15), corner_radius=5, fg_color="white", border_color="gray", border_width=1, text_color="black", width=535, height=100)
...
# =======================COLUMN-2==========================================================
        ...
        # input fields
        dob_lbl = Label(self.main_frame,text="D.O.B. *",font=("Segoe UI", 13),bg="white").place(x=380,y=110)
        contact_lbl = Label(self.main_frame,text="Contact *",font=("Segoe UI", 13),bg="white").place(x=380,y=150)
        adm_date_lbl = Label(self.main_frame,text="Adm. Date *",font=("Segoe UI", 13),bg="white").place(x=360,y=190)
        course_lbl = Label(self.main_frame,text="Course *",font=("Segoe UI", 13),bg="white").place(x=380,y=230)


        # user input here--------------------------------------------------------

        self.dob_text = ctk.CTkEntry(self.main_frame, textvariable=self.dob_var, font=("Helvetica", 15), corner_radius=5, fg_color="white", border_color="gray", border_width=1, text_color="black", width=200, height=35,placeholder_text="DD/MM/YYYY")
        self.dob_text.place(x=470, y=110)


        contact_txt = ctk.CTkEntry(self.main_frame,textvariable=self.contact_var,font=("Helvetica", 15),corner_radius=5, fg_color="white", border_color="gray", border_width=1,text_color="black", width=200, height=35,validate="key",validatecommand=vcmd).place(x=470,y=150)


        adm_date_text = ctk.CTkEntry(self.main_frame, textvariable=self.adm_date_var, font=("Helvetica", 15), corner_radius=5, fg_color="white", border_color="grey", border_width=1, text_color="black", width=200, height=35).place(x=470, y=190)
        ...
        self.course_txt = ctk.CTkComboBox(self.main_frame, values=self.course_list, variable=self.course_var, font=("Helvetica", 15),state='readonly', corner_radius=5, fg_color="white", border_color="grey", border_width=1, text_color="black", width=200, height=35, dropdown_font=("Helvetica", 15), dropdown_fg_color="white", dropdown_text_color="black", button_color="#a6a5a5", button_hover_color="#e0e0e0")
...
# ================================functional buttons========================================
        ...
        self.save_btn = ctk.CTkButton(self.main_frame, text="Save", font=ctk.CTkFont("Segoe UI", 15,"bold"),
                                    ...
                                    corner_radius=10, cursor="hand2", width=110, height=40,command=self.add_student)
        self.save_btn.place(x=120, y=450)
        ...
        self.update_btn.place(x=250, y=450)
        ...
        self.delete_btn.place(x=380, y=450)
        ...
        self.clear_btn.place(x=510, y=450)

# =========================================================================================
# ===========================Right side of the window======================================
        # search bar
        roll_no_search = Label(self.main_frame,text="Search Roll No.",font=("Segoe UI", 13),bg="white").place(x=700,y=110)

        self.var_search_rollNo = StringVar()
        rollNo_search_bar = ctk.CTkEntry(self.main_frame, textvariable=self.var_search_rollNo, font=("Helvetica", 15), corner_radius=5, fg_color="white", border_color="grey", border_width=1, text_color="black", width=180, height=35,validate="key").place(x=840, y=105)

        # Search Button
        self.search_btn = ctk.CTkButton(self.main_frame, text="Search", font=ctk.CTkFont("Segoe UI", 15,"bold"),
                                        fg_color="#1a1a40", hover_color="#21649A", text_color="white",
                                        corner_radius=10, cursor="hand2", width=110, height=40,command=self.search_student_roll)
    ...
    def add_student(self):
        ...
        try:
            ...
            if (
                ...
                self.adm_date_var.get().strip() == "" or
                self.dob_var.get().strip() == "" or
                self.pin_var.get().strip() == "" or
            ...
            # pincode check only 6 digits are allowed
            if not self.pin_var.get().strip().isdigit() or len(self.pin_var.get().strip()) != 6:
                messagebox.showerror("Invalid Pincode", "Pincode must be a 6-digit number.", parent=self.root)
                return
            ...
            try:
                ...
                messagebox.showerror("Invalid DOB", "Date of Birth must be in DD-MM-YYYY format.", parent=self.root)
                return
            ...
            if self.roll_var.get() == "":
                ...
                if row == None:  #this means the course entered is not in my database
                    ...
                    if op == True:
                        ...
                        self.delete_btn.configure(state="disabled") #disable the delete button again
    ...
    def search_student_roll(self):
        ...
        cur = con.cursor()
        try:
            if self.var_search_rollNo.get().strip() == "":
                return
