...
class CourseManagement:
    def __init__(self,root):
        ...
        # the title
        # our title
        title = Label(self.root, text="Course Management Panel",font=("Helvetica", 20, "bold"), bg="#1a1a40", fg="white")
        ...
        # input fields-----------------------------------------------------------------------
        course_name = Label(self.root,text="Course Name",font=("Helvetica", 13 ),bg="white").place(x=20,y=110)
        duration_lbl = Label(self.root,text="Duration",font=("Helvetica", 13),bg="white").place(x=20,y=150)
        charges_lbl = Label(self.root,text="Charges",font=("Helvetica", 13),bg="white").place(x=20,y=190)
        description_lbl = Label(self.root,text="Description",font=("Helvetica", 13),bg="white").place(x=20,y=230)

        # user input here----------------------------------------------------------------

        self.course_name_txt = ctk.CTkEntry(self.root, textvariable=self.course_var, font=("Helvetica", 15), corner_radius=5, fg_color="white", border_color="gray", border_width=1, text_color="black", width=230, height=35)
        self.course_name_txt.place(x=180, y=110)
        self.course_name_txt.bind("<Return>", self.prefill_data_from_course)


        duration_txt = ctk.CTkEntry(self.root, textvariable=self.duration_var, font=("Helvetica", 15), corner_radius=5, fg_color="white", border_color="grey", border_width=1, text_color="black", width=230, height=35).place(x=180, y=150)

        charges_txt = ctk.CTkEntry(self.root,textvariable=self.charges_var,font=("Helvetica", 15),corner_radius=5, fg_color="white", border_color="gray", border_width=1,text_color="black", width=230, height=35).place(x=180,y=190)

        self.description_txt = ctk.CTkTextbox(self.root, font=("Helvetica", 15), corner_radius=5, fg_color="white", border_color="gray", border_width=1, text_color="black", width=400, height=100)
        ...
        self.save_btn.place(x=120,y=400,width=110,height=40)
        ...
        self.update_btn.place(x=250,y=400,width=110,height=40)
        ...
        self.delete_btn.place(x=370,y=400,width=110,height=40)
        ...
        self.clear_btn.place(x=490,y=400,width=110,height=40)


        # search bar---------------------------------------------------------
        course_name_search = Label(self.root,text="Search Course",font=("Helvetica", 13 ),bg="white").place(x=700,y=110)

        self.var_search = StringVar()
        course_search_bar = ctk.CTkEntry(self.root, textvariable=self.var_search, font=("Helvetica", 15), corner_radius=5, fg_color="white", border_color="grey", border_width=1, text_color="black", width=180, height=35).place(x=840, y=105)

        search_btn = Button(self.root,text="Search",font=("Helvetica", 12),bg='#0a2645',fg="white",bd='0',activebackground='#2b6cb0',activeforeground="white",cursor='hand2',command=self.search_course).place(x=1040,y=105,width=110,height=35)
        ...
        try:
            if self.course_var.get() == "":
                ...
                if row != None: #this means entered coursee name is already in my db
                    ...
                    # means agr nhi hua to main ye course db me add kar dungi
